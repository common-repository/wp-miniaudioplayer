...
[youtube https://www.youtube.com/watch?v=lFEtzQk01Xw]
...
= 1.9.7 =
* Excluded [download] anchors to be rendered as player.

= 1.9.6 =
* Bugfix: With the latest Worpress update the default gutenberg audio block was not rendered anymore in the right way.

= 1.9.5 =
* Bugfix: Removed the jQuery.browser object.

= 1.9.4 =
* New feature: Now the playlist plays the next track automatically.

= 1.9.3 =
* Bugfix: Still problems with the javascript .min path.

= 1.9.2 =
* Bugfix: fixed a path problem to map_short_code.js that was blocking the editor.
...
= 1.8.10 =
* Bug fix: There was a bug with the settings page, the HTML5 download option was always set to true.

= 1.8.9 =
* Bug fix: There was a bug with the download button if set to HTML5 download.

= 1.8.8 =
* Updates: Introduced the "Use default browser download capabilities" option to let the audio file be downloaded usung the default browser HTML5 capabilities without using the "fopen" or the "curlLib" PHP module.

= 1.8.7 =
* Updates: map_download: the download process should be more robust.

= 1.8.6 =
* Updates: Worked on the editor button to better perform the insert action and prevent the use of it if on text modality.

= 1.8.5 =
* Bug fix: removed a out-print debug from the post/page editor.

= 1.8.4 =
* Bug fix: Prevent "fatal error" if the PHP installed version is prior than 5.4.0.

= 1.8.3 =
* Bug fix: changed the player editor popup behavior in the post/page editor for an issue with Wordpress 4.8.
